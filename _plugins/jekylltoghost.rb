...
module Jekyll
	...
	class JsonFileGenerator < Generator
        ...
        def author_objects(site)
            ...
            default_author = {
                "id" => 1,
                "name" => "Chris Pelatari", # Change this to your name
                "slug" => nil, # Change this to your slug, or keep it nil. Ghost will automatically assign one if nil
                "email" => "chris@bluefenix.net", # Change this to your email
                ...
                "website" => "https://chris.pelatari.com", # Change this to your website
